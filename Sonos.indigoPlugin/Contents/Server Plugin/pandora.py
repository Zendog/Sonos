...
if __name__ == "__main__":
    ...
    # authenticate
    print("Authenthicated: " + str(pandora_var.authenticate(username, password)))

    # output stations (without QuickMix)
    print("users stations:")
    for station in pandora_var.get_station_list():
    ...
    pandora_var.switch_station(quickmix)

    # get one song from quickmix
    print("next song from quickmix:")
    next = pandora_var.get_next_song()
